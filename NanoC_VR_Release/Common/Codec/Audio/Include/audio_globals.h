...
//btPhoneFunc.c
unsigned long BtPhonePCMFunction(unsigned long ulIoctl, unsigned long ulParam1,
        unsigned long ulParam2, unsigned long ulParam3);
...
//voiceNotifyIf.c
unsigned long BtVoiceNotifyFunction(unsigned long ulIoctl, unsigned long ulParam1,
        unsigned long ulParam2, unsigned long ulParam3);
