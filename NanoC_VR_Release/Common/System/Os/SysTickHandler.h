...
/*
extern UINT32 SystickTimerCheck(SYSTICK_LIST *pSystick);
extern UINT32 SystickTimerSafeStart(SYSTICK_LIST *pSystick);
extern UINT32 SystickTimerSafeStop(SYSTICK_LIST *pSystick);
extern UINT32 SystickTimerSafeReStart(SYSTICK_LIST *pSystick);
