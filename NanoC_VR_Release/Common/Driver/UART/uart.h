...
extern int32 UARTInit(uint32 clk,eUART_BaudRate baudRate,eUART_dataLen dataBit,eUART_stopBit stopBit,eUART_parity_en parity);
...
//typedef int32 (*pUARTInit)(uint32 clk,eUART_BaudRate baudRate,eUART_dataLen dataBit,eUART_stopBit stopBit,eUART_parity_en parity);
...
//#define UARTInit(clk,baudRate, dataBit, stopBit, parity) (((pUARTInit              )(Addr_UARTInit              ))(clk,baudRate, dataBit, stopBit, parity))
extern int32 UARTInit(uint32 clk,eUART_BaudRate baudRate,eUART_dataLen dataBit,eUART_stopBit stopBit,eUART_parity_en parity);
