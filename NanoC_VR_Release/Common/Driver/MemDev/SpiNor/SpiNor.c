...
static void SPIIomux(uint32 index)
{
    ...
    else
    {
        ...
        #if 1
        //GRFReg->GPIO0A_IOMUX = 0<<12|3<<28; //使用GPIOA[6]做SPI Flash0的CS
        //GRFReg->GPIO0A_IOMUX = 0<<13|3<<28; //使用GPIOA[6]做SPI Flash0的CS
...
/*extern*/ uint32 ProbeReadBuf[2048/4];   //FLASH探测时用的PAGE BUF
/*extern*/ uint32 ProbeWriteBuf[2048/4];  //FLASH探测时用的PAGE BUF
//uint8 TestSPIRet;
