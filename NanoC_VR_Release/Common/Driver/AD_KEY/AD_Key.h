...
#define KEY_VAL_NB_DOWN           ((KEY_VAL_NB)|(KEY_STATUS_DOWN))           
#define KEY_VAL_NB_PRESS_START    ((KEY_VAL_NB)|(KEY_STATUS_PRESS_START))    
#define KEY_VAL_NB_PRESS          ((KEY_VAL_NB)|(KEY_STATUS_PRESS))          
#define KEY_VAL_NB_SHORT_UP       ((KEY_VAL_NB)|(KEY_STATUS_SHORT_UP))       
#define KEY_VAL_NB_LONG_UP        ((KEY_VAL_NB)|(KEY_STATUS_LONG_UP)) 
