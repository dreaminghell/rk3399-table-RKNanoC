...
--------------------------------------------------------------------------------
*/
_ATTR_DRIVER_BSS_ EXT UINT8 I2C_slaveaddr_raw ;
...
extern BOOL i2c1_slaveaddress_init(uint8 address);
extern BOOL i2c1_reg16_write8(uint8 slave_addr, uint16 address, uint8 data);
extern BOOL i2c1_reg16_write16(uint8 slave_addr, uint16 address, uint16 data);
extern BOOL i2c1_reg16_write32(uint8 slave_addr, uint16 address, uint32 data);
extern BOOL i2c1_reg16_read8(uint8 slave_addr, uint16 address, uint8 *data);
extern BOOL i2c1_reg16_read16(uint8 slave_addr, uint16 address, uint8 *data);
extern BOOL i2c1_reg16_read32(uint8 slave_addr, uint16 address, uint8 *data);

extern BOOL i2c1_reg8_write8(uint8 slave_addr, uint8 address, uint8 data);
extern BOOL i2c1_reg8_read8(uint8 slave_addr, uint8 address, uint8 *data);
extern BOOL i2c1_reg8_write32(uint8 slave_addr, uint8 address, uint32 data);
extern BOOL i2c1_reg8_read(uint8 slave_addr, uint8 address, uint8 *data, uint8 size);
extern BOOL i2c1_reg8_write(uint8 slave_addr, uint8 address,uint8 *data, uint8 size);

extern uint8 i2c_read_data(uint8 slaveaddr, uint8 address, uint8 *data, uint8 size);
extern uint8 i2c_write_data(uint8 slaveaddr, uint8 address, uint8 data, uint8 size);
